---
ref: TSK-220
title: Use the dotted dialog instead of blurring the bg for dialog windows
status: todo
priority: medium
complexity: M
category: feature
...
Use this instead of out blurring effect
...
```tsx
/components/iu / dotted - dialog.tsx;
("use client");
...
```bash
@radix-ui/react-icons, @radix-ui/react-dialog, @radix-ui/react-slot, class-variance-authority, lucide-react, @radix-ui/react-label, @radix-ui/react-checkbox
```
