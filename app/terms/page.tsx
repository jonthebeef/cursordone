  ...
  return (
    <div className="max-w-3xl mx-auto p-8">
      ...
      <div className="prose prose-invert">
        ...
        <p className="mb-4">
          Your use of this application is also governed by our Privacy Policy, which is incorporated into these terms and conditions by reference.
        </p>

        <h2 className="text-xl font-semibold mt-8 mb-4">6. Responsibility</h2>
        <p>
          By using Cursor Done, you agree that you&apos;re responsible for your own actions and content. We don&apos;t control what you do with the app.
        </p>
      </div>
    </div>
  )
